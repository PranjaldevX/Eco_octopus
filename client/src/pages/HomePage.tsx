    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50 dark:from-gray-950 dark:to-gray-900">
        ...
        <div className="relative z-20 container mx-auto px-4 text-center">
          <div className="animate-in fade-in-0 slide-in-from-bottom-4 duration-1000">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link href="/register">
                <Button size="lg" className="bg-white text-green-600 hover:bg-gray-100 shadow-2xl hover:shadow-3xl transition-all duration-300 text-lg px-8 py-6 group">
                  Get Started Free
        ...
        <div className="container mx-auto">
          <div className="text-center mb-16 animate-in fade-in-50 duration-1000">
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-4">
              Recycling Made <span className="text-green-600">Simple & Rewarding</span>
            </h2>
      ...
      <section className="py-24 px-4 bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-950">
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-8 relative">
            {/* Connection Line */}
            <div className="hidden md:block absolute top-16 left-0 right-0 h-1 bg-gradient-to-r from-green-400 via-emerald-500 to-teal-500 opacity-20"></div>
            ...
            {[
              ...
              <div key={index} className="text-center relative animate-in fade-in-50 slide-in-from-bottom-4" style={{ animationDelay: `${index * 150}ms` }}>
                <div className="w-16 h-16 rounded-full bg-gradient-to-br from-green-500 to-emerald-600 text-white text-2xl font-bold flex items-center justify-center mx-auto mb-4 shadow-lg relative z-10">
                  {item.step}
                </div>
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          <Link href="/register">
            <Button size="lg" className="bg-white text-green-600 hover:bg-gray-100 shadow-2xl text-lg px-8 py-6">
