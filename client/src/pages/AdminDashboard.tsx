...
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs";
import { Badge } from "@/components/ui/badge";
import { Building2, Truck, Package, Recycle, CheckCircle2, AlertCircle, Loader2, Clock, ArrowRight, Shield, XCircle } from "lucide-react";
import { useToast } from "@/hooks/use-toast";
import { useState } from "react";
              ...
              {pendingCompanies.length === 0 ? (
                ...
                pendingCompanies.map((company, index) => {
                  ...
                  return (
                    ...
                    >
                      <div>
                        <div className="font-medium">{company.company_name || company.companyName}</div>
                        <div className="text-sm text-muted-foreground">{company.registration_number || company.registrationNumber}</div>
                        <div className="text-sm text-muted-foreground">{company.email}</div>
                      </div>
                      <div className="flex gap-2">
                        <Button 
