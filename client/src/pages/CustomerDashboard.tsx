    ...
    <div className="space-y-6 relative min-h-screen">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-4">
          <Card className="overflow-hidden relative hover:shadow-xl transition-all duration-300 border-2 border-green-200/50 dark:border-green-800/50">
          ...
          <Card className="overflow-hidden relative bg-gradient-to-br from-green-500 via-emerald-500 to-teal-500 text-white border-0 shadow-2xl hover:shadow-3xl transition-all duration-300 hover:-translate-y-2 hover:scale-105">
      ...
      <Dialog open={showProductDetails} onOpenChange={(open) => {
        ...
        <DialogContent className="sm:max-w-[650px] max-h-[90vh] overflow-hidden p-0 gap-0 animate-in fade-in-0 zoom-in-95 duration-300">
          ...
          <div className="relative bg-gradient-to-br from-green-500 via-emerald-500 to-teal-500 pt-8 pb-16 px-6 overflow-hidden">
            {/* Animated Wave SVG */}
            <div className="absolute bottom-0 left-0 right-0">
              <svg className="w-full h-16" viewBox="0 0 1200 120" preserveAspectRatio="none">
                <path 
          ...
          {scannedProduct && (
            <div className="space-y-4 p-6 max-h-[calc(90vh-180px)] overflow-y-auto animate-in slide-in-from-bottom-4 duration-500">
              {calculatedReward && (
                <Card className="bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 border-2 border-green-300 dark:from-green-950/20 dark:to-emerald-950/20 dark:border-green-800 shadow-lg animate-in slide-in-from-top-2 duration-500">
                  <CardContent className="pt-6">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <div className="text-4xl font-bold text-green-600 dark:text-green-400 animate-in zoom-in-50 duration-700">
                          ₹{calculatedReward.reward_points.toFixed(2)}
                        </div>
                        <div className="text-xs text-green-600/80 dark:text-green-400/80 mt-2 font-medium">
                          💰 Earn when product is collected • 1 point = ₹1
                        </div>
                      </div>
                      <div className="relative">
                        <div className="absolute inset-0 bg-green-400 rounded-full blur-xl opacity-30 animate-pulse"></div>
                        <Award className="w-16 h-16 text-green-600 dark:text-green-400 relative animate-in spin-in-180 duration-1000" />
                      </div>
                    </div>
                  </CardContent>
                </Card>
            ...
            {calculateRewardMutation.isPending && (
              ...
              <div className="flex gap-3 pt-6 animate-in slide-in-from-bottom-4 duration-700">
                <Button 
                  ...
                  className="flex-1 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white shadow-lg hover:shadow-xl transition-all duration-300 h-12"
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
        <TabsList className="grid w-full grid-cols-3 bg-green-100/50 dark:bg-green-900/20 p-1">
          <TabsTrigger 
            value="products" 
